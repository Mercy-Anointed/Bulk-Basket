      ...
      <div className='flex flex-col gap-4 px-4 md:px-10 lg:px-24'>
        ...
        <div  className='flex flex-col gap-4 px-4 md:px-10 lg:px-24 md:mt-15'>
                ...
                <div className='group flex flex-row justify-between '>
                    <button onClick={() => navigate("/products")} className='text-primary border border-gray-300 rounded-full hover:bg-primary hover:text-gray-700 md:py-2 md:px-25'>Continue Shopping</button>
                    <button onClick={() => navigate("/checkout")} className='bg-primary text-white rounded-full md:py-2 md:px-25'>Proceed to Checkout</button>
                </div>
            </div>
